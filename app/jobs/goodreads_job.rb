class GoodreadsJob < ApplicationJob
  ...
  def perform
    ...
    parsed_items = []
    items = get_xml('https://www.goodreads.com/user/updates_rss/10905654***REMOVED***', 'goodreads_expiry')
    ...
    items.each do |item|
      ...
      parsed_items << {
        ...
        thumb_url: store_local_copy(thumb_url, 'goodreads_thumb', normalize_title(title)),
